...
namespace HotelProject.WebUI.Controllers
{
    public class AdminAboutController : Controller
    {
        ...
        public async Task<IActionResult> UpdateAbout(int id)
        {
            ...
            var responseMessage = await client.GetAsync($"http://localhost:5279/api/AboutUs/{id}"); //get async ile güüncellenecek verileri getir.
        ...
        public async Task<IActionResult> UpdateAbout(UpdateAboutDto model)
        {
            ...
            var responseMessage = await client.PutAsync("http://localhost:5279/api/AboutUs/", stringContent); // update için put
            if (responseMessage.IsSuccessStatusCode)
            {
